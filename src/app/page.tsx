...
export default function Home() {
  ...
  return (
    <>
      <Header />
      <main className="flex flex-col items-center justify-center min-h-[80vh] px-6 cursor-default">
          <div className="text-center space-y-8 md:space-y-12">
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-light tracking-[0.2em] leading-tight">
            CADE LOAR
          </h1>
          <p className='text-sm md:text-base font-light tracking-[0.15em] leading-relaxed max-w-3xl dark:text-gray-300 text-gray-600'>
            {/* SOFTWARE ENGINEER ___ AI ENTHUSIAST ___ PRODUCT MANAGER */}
            product-focused engineer exploring the intersection of business, technology, AI, and design to create innovative solutions.
          </p>
